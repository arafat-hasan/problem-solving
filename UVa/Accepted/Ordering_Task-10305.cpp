/*
 * FILE: Ordering_Task-10305.cpp
 *
 * @author: Md. Arafat Hasan Jenin <arafathasanjenin[at]gmail[dot]com>
 *
 * LINK: https://uva.onlinejudge.org/external/103/10305.pdf
 *
 * Description:
 *
 * DEVELOPMENT HISTORY:
...
void topsort(int size) { //cycle checking not needed
...
int main() {
    ...
    while (cin >> n >> m) {
        ...
        v = tops.size();
        cout << tops[0];
        FOR(i, 1, n - 1) cout << " " << tops[i];
        ln;
        REP(i, 100) adj[i].clear();
